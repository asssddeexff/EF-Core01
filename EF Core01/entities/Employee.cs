...
namespace EF_Core01.entities
{
    ...
    //2.Data Annotation [ Set Of Attrubites Used For Data Validation ]
    //3.Fluent APIS
    ...
    //    public string Name { get; set; }//Reference Type : Requeried [Not Allow Null ] - nvarchar(max)
    //    public int? Age { get; set; }//Nullable  Value Type:int[Age] - Optional - [Allow Null]
    //    public double Salary { get; set; }//Value Type : float[Salary] - Requeried
    //    public string Email { get; set; }//nvarchar(max) - optional
    //    public DateTime DateOfCreation { get; set; }//datetime2 - Requeried
    // }
